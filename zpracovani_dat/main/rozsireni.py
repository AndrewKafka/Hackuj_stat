...
for cesta_csv in soubory:
    ...
    chybejici_indexy = [nazev for nazev in nazvy_indexu if nazev not in df.columns]
    if chybejici_indexy:
        print(f"Soubor {nazev_souboru} nemá sloupce {chybejici_indexy}, zpracují se jen dostupné.")
